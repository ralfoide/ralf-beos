...
//*************************************************
{
	...
	float raie = frame.meanFftBass[0];
	float raie1 = frame.meanFftBass[2]/592;
	float diffraie = (raie-lastRaie);
	float diffraie1 = (raie1-lastRaie1);
	idealraie = idealraie+(diffraie1-idealraie)/6;
	lastRaie = raie;
	lastRaie1 = raie1;
