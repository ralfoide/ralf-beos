...
#include <typeinfo.h>	// for RTTI type_info stuff
...
//	catch(status_t __err)	{ gThrowAlertStatusT(name, __err);	} -- BeOS Specific
...
//	catch(status_t __err)	{ gThrowAlertStatusT(name, __err);	throw; }  -- BeOS Specific
